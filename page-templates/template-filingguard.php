...
<!-- HERO -->
<section class="fgp-hero">
	<div class="fgp-wrap fgp-hero-grid">
	<div>
		<div class="pill-badge"><span class="fgp-tag">US + CANADA</span> Built for non-resident owners</div>
		...
		<div class="hero-cta">
		<a href="#start" class="fgp-btn fgp-btn-gold btn-lg">Start tracking free<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2"><path d="M5 12h14M13 6l6 6-6 6"/></svg></a>
		<a href="#how" class="fgp-btn btn-ghost btn-lg">See how it works</a>
		</div>
		<div class="hero-trust">
		<span class="fgp-d"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20 7L9 18l-5-5"/></svg>No card to start</span>
		<span class="fgp-d"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20 7L9 18l-5-5"/></svg>Set up in 3 minutes</span>
		<span class="fgp-d"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20 7L9 18l-5-5"/></svg>Cancel anytime</span>
		</div>
	</div>
...
<section class="band paper" id="problem">
	...
	<div>
		<div class="fgp-eyebrow">The filing nobody warns you about</div>
...
<section class="band" id="features">
	...
	<div class="center" style="max-width:640px">
		<div class="fgp-eyebrow">What you get</div>
...
<section class="band" id="pricing">
	<div class="fgp-wrap">
	<div class="center" style="max-width:600px">
		<div class="fgp-eyebrow">Simple pricing</div>
	...
	<div class="fgp-price-grid">
		<div class="fgp-plan">
		<div class="pn">Solo</div>
		<div class="pp"><span class="fgp-amt"><?php echo esc_html( cpf_package_price_label( cpf_get_package_by_key( 'fg-basic' )->ID, false ) ); ?></span><span class="per">/ month</span></div>
		...
		<a href="#start" class="fgp-btn btn-ghost">Join the waitlist</a>
		</div>
		<div class="fgp-plan feature">
		<div class="pn">Owner</div>
		<div class="pp"><span class="fgp-amt"><?php echo esc_html( cpf_package_price_label( cpf_get_package_by_key( 'fg-pro' )->ID, false ) ); ?></span><span class="per">/ month</span></div>
		...
		<a href="#start" class="fgp-btn fgp-btn-gold">Join the waitlist</a>
		</div>
		<div class="fgp-plan">
		<div class="pn">Pro</div>
		<div class="pp"><span class="fgp-amt"><?php echo esc_html( cpf_package_price_label( cpf_get_package_by_key( 'fg-scale' )->ID, false ) ); ?></span><span class="per">/ month</span></div>
...
<section class="band paper" id="faq">
	<div class="fgp-wrap">
	<div class="center" style="max-width:600px">
		<div class="fgp-eyebrow">Good to know</div>
...
<section class="band" id="start">
	...
	<div class="cta-band">
		...
		<div class="fgp-lead">
			...
			<button id="fg-submit" class="fgp-btn fgp-btn-gold">Get early access<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2"><path d="M5 12h14M13 6l6 6-6 6"/></svg></button>
